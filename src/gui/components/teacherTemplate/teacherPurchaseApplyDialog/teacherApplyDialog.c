...
BOOL CALLBACK TeacherApplyDlgProc(HWND hDlg, UINT message,
    WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
    {
        hLabTitle = CreateWindow(
            ...
            30, 10, 220, 50,
            hDlg,
            (HMENU)ID_YUFFIE_TEACHER_PURCHASE_APPLY_TITLE_LAB,
            hInst, 
            NULL
        );
        ...
        hwndList = CreateWindow(
            ...
            300,
            hDlg, 
            (HMENU)ID_YUFFIE_TEACHER_PURCHASE_APPLY_LIST,
            hInst,
            NULL
        );
        ...
        addButton = createDefaultButton(
            ...
            450, 100, 150, 50,
            hDlg,
            (HMENU)ID_YUFFIE_TEACHER_PURCHASE_ADD_BUTTON,
            hInst
        );
        ...
        deleteButton = createDefaultButton(
            ...
            450, 160, 150, 50,
            hDlg,
            (HMENU)ID_YUFFIE_TEACHER_PURCHASE_DELETE_BUTTON,
            hInst
        );
        ...
        finishButton = createDefaultButton(
            ...
            450, 220, 150, 50,
            hDlg,
            (HMENU)ID_YUFFIE_TEACHER_PURCHASE_COMMIT_BUTTON,
            hInst
        );
    ...
    case WM_COMMAND:
    {
        switch (LOWORD(wParam)) {
            case ID_YUFFIE_TEACHER_PURCHASE_ADD_BUTTON: {
                DialogBox(hInst, MAKEINTRESOURCE(IDD_PURCHASE_APPLY_ADD_DIALOG), hDlg, PurchaseApplyAddDlgProc);
                break;
            }
            case ID_YUFFIE_TEACHER_PURCHASE_DELETE_BUTTON:
            {
